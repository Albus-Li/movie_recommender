...
# %% md
# < img
# src = "assets/text_cnn.png" / >
# 图片来自Kim
# Yoon的论文：[`Convolutional Neural Networks
# for Sentence Classification`](https://
#     arxiv.org / abs / 1408.5882)
#
# 将卷积神经网络用于文本的文章建议你阅读[`Understanding
# Convolutional
# Neural
# Networks
# for NLP`](http://
#     www.wildml.com / 2015 / 11 / understanding - convolutional - neural - networks -
# for -nlp /)
# %% md
# 网络的第一层是词嵌入层，由每一个单词的嵌入向量组成的嵌入矩阵。下一层使用多个不同尺寸（窗口大小）的卷积核在嵌入矩阵上做卷积，窗口大小指的是每次卷积覆盖几个单词。这里跟对图像做卷积不太一样，图像的卷积通常用2x2、3
# x3、5
# x5之类的尺寸，而文本卷积要覆盖整个单词的嵌入向量，所以尺寸是（单词数，向量维度），比如每次滑动3个，4
# 个或者5个单词。第三层网络是max
...
#     https: // www.tensorflow.org / api_docs / python / tf / Graph  # get_tensor_by_name)从 `loaded_graph` 中获取tensors，后面的推荐功能要用到。
# %%
...
# for Text Classification in Tensorflow`](https://
